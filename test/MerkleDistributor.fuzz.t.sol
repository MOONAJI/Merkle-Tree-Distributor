...
contract MerkleDistributorFuzzTest is Test {
     ...
     */
    function testFuzz_RevertWhen_InvalidMerkleRoot(
        uint256 totalYield,
        uint256 startTime,
        uint256 duration
    ) public {
     ...
     */
    function testFuzz_RevertWhen_ZeroTotalYield(
        bytes32 merkleRoot,
        uint256 startTime,
        uint256 duration
    ) public {
     ...
     */
    function testFuzz_RevertWhen_ZeroAmount(
        address claimer,
     ...
     */
    function testFuzz_RevertWhen_DistributionInactive(
        address claimer,
        uint256 amount,
        bytes32[] calldata proof
    ) public {
     ...
     */
    function testFuzz_RevertWhen_BeforeStartTime(
        address claimer,
        uint256 amount,
        uint256 startOffset
    ) public {
     ...
     */
    function testFuzz_RevertWhen_AfterEndTime(
        address claimer,
        uint256 amount,
        uint256 warpTime
    ) public {
     ...
     */
    function testFuzz_RevertWhen_InvalidDistributionId(
        address claimer,
        uint256 amount,
        uint256 invalidId
    ) public {
     ...
     */
    function testFuzz_BatchClaimArrayLengths(
        uint8 arrayLength
    ) public {
     ...
     */
    function testFuzz_RevertWhen_MismatchedArrayLengths(
        uint8 idsLength,
        uint8 amountsLength,
        uint8 proofsLength
    ) public {
        ...
        vm.assume(
            idsLength != amountsLength || 
            idsLength != proofsLength || 
            amountsLength != proofsLength
        );
     ...
     */
    function testFuzz_TimeWindowBoundaries(
        uint256 startOffset,
        uint256 duration,
        uint256 claimTime
    ) public {
     ...
     */
    function testFuzz_BlockTimestampManipulation(
        uint256 timestamp
    ) public {
    ...
    function testFuzz_ExtremeAmounts(
        ...
        try token.mint(address(distributor), amount) {
            ...
            (, uint256 storedAmount, , , , ,) = 
                distributor.distributions(distributor.distributionCount() - 1);
     ...
     */
    function testFuzz_AmountPrecision(
        uint256 amount
    ) public {
     ...
     */
    function testFuzz_AddressValidation(
        address claimer
    ) public {
     ...
     */
    function testFuzz_ProofArrayLength(
        uint8 proofLength
    ) public {
     ...
     */
    function testFuzz_DuplicateProofElements(
     ...
     */
    function testFuzz_DistributionStateConsistency(
    ...
    function testFuzz_TotalSupplyConservation(
        ...
        (, uint256 totalYield, , , uint256 claimedAmount, ,) = 
            distributor.distributions(0);
